...
/**
 * Boots the application against real PostgreSQL (pgvector) and RabbitMQ containers under the
 * {@code prod} profile, proving Flyway migrations apply and the Rabbit connection is live.
