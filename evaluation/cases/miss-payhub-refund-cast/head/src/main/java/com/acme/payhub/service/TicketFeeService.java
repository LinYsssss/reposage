 ...
 * 手续费计算。
 *
 * <p>费率从 merchant_fee_config 表读取，不在代码中硬编码；结果向下取整，
 * 差额由平台承担。
 */
public class TicketFeeService {

    private final FeeConfigGateway feeConfigs;

    public TicketFeeService(FeeConfigGateway feeConfigs) {
