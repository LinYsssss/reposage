...
public class CommissionCalculator {
    ...
    private final MerchantRateRepository rateRepository;

    public CommissionCalculator(MerchantRateRepository rateRepository) {
    ...
    private int resolveRateBp(Long tenantId, Long merchantId) {
        Optional<Integer> configured = rateRepository.findEffectiveRateBp(tenantId, merchantId);
